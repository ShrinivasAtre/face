...
| 10 | Stage 21.4 enrollment/profile administration | In progress | Windows CNG store, profile lifecycle, DPAPI local keys, portable export, media capture, and transactional import/re-encryption implemented; Linux crypto, provider integration and rollback remain |
