...
| 9 | Local pretrained baselines | Windows complete; cross-platform pending | Public-fixture recognition/PAD plumbing and latency measured; no accuracy/threshold claim |
