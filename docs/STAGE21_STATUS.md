...
| 10 | Stage 21.4 enrollment/profile administration | In progress | Windows CNG store, profile lifecycle, media capture, export, and transactional import/re-encryption implemented; protected local keys, Linux crypto, provider integration and rollback remain |
