...
| 21.4 | Enrollment application | Authorized; in progress | Encrypted cross-platform profile foundation and fail-closed enrollment processor pass; model adapters, Orin and usability remain |
